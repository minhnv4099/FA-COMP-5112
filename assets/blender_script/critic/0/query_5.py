...
# Function to add lighting setup
def add_lighting_setup():
    ...
    # Fill Light
    bpy.ops.object.light_add(type='POINT', radius=1, location=(-3, 3, 2))
    ...
    print("Lighting setup (key, fill, back lights) added to the scene.")
