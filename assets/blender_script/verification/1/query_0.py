...
def create_character():
    ...
    for obj in [left_eye, right_eye, mouth, nose, left_ear, right_ear, left_arm, right_arm, left_leg, right_leg]:
...
def add_depth_with_defocus():
    ...
    # Removed unsupported attribute 'preview'
