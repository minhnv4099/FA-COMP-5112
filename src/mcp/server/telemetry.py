...
def get_package_version() -> str:
    ...
    try:
        ...
        logger.error(f"Error getting package version: {str(_)}")
    return "unknown"
...
class TelemetryCollector:
    ...
    def __init__(self):
        ...
        self._customer_uuid: str = self._get_uuid()
        self._session_id: str = str(uuid.uuid4())

        self._queue: queue.Queue[TelemetryEvent] = queue.Queue(maxsize=100)
